...
def print_header(text):
    ...
    print(f"{Colors.BLUE}{Colors.BOLD}{text_clean}{Colors.END}")
...
def main():
    ...
    # Step 4: Test Form Data Validation
    print(f"\n{Colors.BLUE}Step 4: Testing Form Data Validation...{Colors.END}")
    
    # Test Customer Create (minimal data)
    try:
        customer_data = {
